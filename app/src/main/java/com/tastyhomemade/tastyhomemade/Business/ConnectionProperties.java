...
public class ConnectionProperties {
    public static String IP = "sql5013.smarterasp.net";
    public static String UserName = "DB_A1543F_tastyhomemade_admin";
...
//    public static String DatabaseName= "wwwtasty_tastyhomemade";
    ...
    public static String SiteUrl = " http://tastyhomemade-001-site1.gtempurl.com";
