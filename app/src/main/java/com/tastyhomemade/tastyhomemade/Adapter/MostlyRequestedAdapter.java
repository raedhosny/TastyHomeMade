...
public class MostlyRequestedAdapter {
    Context context;
        ...
        for (int i = 0; i <= ObjFoodsList.size() - 1; i++) {
            ...
            Thread t = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    final TextView lblNumberOfRequests = (TextView) v.findViewById(R.id.lblNumberOfRequests);
                    ...
                    CurrentActivity.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            lblNumberOfRequests.setText(Utils.GetResourceName(context, R.string.numberofrequests, new Settings(context).getCurrentLanguageId()) + " " + ObjFoodsList.get(iFinal).getNumberOfRequestsCount());
                        }
                    });
